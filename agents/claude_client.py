...
#
# max_retries=4: Anthropic 서버가 혼잡하면 529(Overloaded)나 429가 오는데,
# SDK가 지수 백오프로 알아서 재시도한다 (기본 2회 → 4회로 상향).
# 실사고(2026-07-16): 529가 그대로 사용자에게 "파싱 중 오류"로 노출됐음 —
# 짧은 혼잡은 재시도로 흡수하고, 그래도 실패하면 뷰가 503으로 안내한다.
