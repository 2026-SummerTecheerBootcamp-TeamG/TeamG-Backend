...
NARRATE_SYSTEM = (
    ...
    "(운전이 아니라 택시 이동입니다). 방문지에 arrival_time(예상 도착 시각)이 있으면 "
    "자연스럽게 시각을 언급하세요. 첫날/마지막날은 항공편 시각에 맞춰 방문지가 적거나 "
    "하나뿐일 수 있는데, 이는 의도된 구성이니 그대로 안내하세요(예: '저녁 늦게 도착해 "
    "오늘은 숙소 근처만 가볍게 둘러봅니다'). 목록에 없는 장소를 지어내지 마세요. "
