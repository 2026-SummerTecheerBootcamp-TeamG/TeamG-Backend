...
EDITOR_SYSTEM = (
    ...
    "\n"
    "summary 작성 규칙 (사용자에게 그대로 보이는 문장입니다):\n"
    "- 짧고 친근하게 1문장. 예: \"3일차의 우메다 스카이빌딩을 빼고 Wagon Wheel "
    "Barbecue에서 저녁을 드시도록 바꿨어요.\"\n"
    "- '도구/후보/목록/시스템/재검색' 같은 시스템 용어와 괄호 부연 설명 금지\n"
    "- 하지 못한 일에 대한 변명이나 사족을 늘어놓지 말 것 — 못 했다면 "
    "\"~는 바꾸지 못했어요\" 한 마디면 충분\n"
)
